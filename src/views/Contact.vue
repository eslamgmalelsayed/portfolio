  ...
  <div class="container mx-auto px-4 py-16 min-h-screen flex flex-col justify-center">
    <div class="max-w-full mx-auto">
      ...
      <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="flex items-start">
              ...
              <div>
                ...
                <div class="flex space-x-4 mt-2">
                  <a title="LinkedIn" href="#" class="text-gray-400 hover:text-blue-500 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                    </svg>
                  </a>
                  <a title="Github" href="#" class="text-gray-400 hover:text-gray-100 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="md:w-2/3">
          <form class="space-y-6" name="contact" @submit.prevent="handleSubmit">
            <!-- Success Alert -->
            <div v-if="submitSuccess" class="bg-white dark:bg-green-800 bg-opacity-100 dark:bg-opacity-30 text-green-700 dark:text-green-400 p-4 rounded-md mb-6 border border-green-200 dark:border-transparent flex items-center">
              <span class="text-xl mr-2">✅</span>
              <span>{{ t('message.messageSent') || 'Your message has been sent successfully!' }}</span>
            </div>
            
            <!-- Error Alert -->
            <div v-if="submitError" class="bg-white dark:bg-red-800 bg-opacity-100 dark:bg-opacity-30 text-red-700 dark:text-red-400 p-4 rounded-md mb-6 border border-red-200 dark:border-transparent flex items-center">
              <span class="text-xl mr-2">❌</span>
            ...
            <div>
              <label for="email" class="block text-sm font-medium text-black dark:text-white mb-1">
                {{ t('message.email') || 'Email' }} <span class="text-red-500">*</span>
              </label>
              <input 
                type="email" 
                id="email" 
            ...
            <div>
              <label for="subject" class="block text-sm font-medium text-black dark:text-white mb-1">
                {{ t('message.subject') || 'Subject' }} <span class="text-red-500">*</span>
              </label>
              <input 
                type="text" 
                id="subject" 
            ...
            <div>
              <label for="message" class="block text-sm font-medium text-black dark:text-white mb-1">
                {{ t('message.message') || 'Message' }} <span class="text-red-500">*</span>
              </label>
              <textarea 
                id="message" 
...
const EMAILJS_SERVICE_ID = 'service_dkk0ifm'; // Replace with your EmailJS service ID
const EMAILJS_TEMPLATE_ID = 'template_4g3agyy'; // Replace with your EmailJS template ID
const EMAILJS_PUBLIC_KEY = 'GIrdG2ts1Cau66lpq'; // Replace with your EmailJS public key
